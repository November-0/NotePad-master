...
//    private String[] dataColumns = { NotePad.Notes.COLUMN_NAME_TITLE, NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE };//加入修改时间;
//    private int[] viewIDs = { android.R.id.text1, R.id.text2 };//加入修改时间;
    /**
